...
[1 Purpose of IT Requirements for Modular Acquisition](#purpose-of-it-requirements-for-modular-acquisition)
...
[1.3 Operational Delivery Models](#operational-delivery-models)
...
[3 State of Alaska DHSS Technology Services and Standards](#state-of-alaska-dhss-technology-services-and-standards)
...
[3.12 State of Alaska DHSS MITA/NHSIA Standards and Department IT Governance](#state-of-alaska-dhss-mitanhsia-standards-and-department-it-governance)
...
identified in the table and diagram below.
  ...
  **Service Line**                    **Description**
  ----------------------------------- -----------------------------------
  Staffing Support                    Services to manage IT support staff
                                      and their availability

  Engagement and Service Delivery     Services to engage with customers
  Management                          and manage delivery of all IT
                                      services

  Project Portfolio Management        Services to support project
                                      management enterprise process
                                      development and execution

  Asset Management                    Services to manage software
                                      licensing and other software and
                                      information assets

  Systems Integration and DDI         Services to support system
                                      architecture development,
                                      integration between DHSS systems
                                      and information system design,
                                      development and implementation

  Systems Operations and              Services to support technical
  Administration                      system operations and system
                                      administration

  Information Security Compliance and Services to support legal
  Privacy                             compliance with information
                                      security, privacy, and ongoing
                                      development/maintenance of security
                                      policy and practice

  Enterprise Desktop and Mobility     Services to define, deploy and
                                      support the DHSS enterprise desktop
                                      and mobility endpoints

  DHSS Hosting and Datacenter         Services to design, implement and
                                      operate standard information
                                      technology infrastructure and
                                      platform offerings

  DHSS Wide Area Network,             Services to integrate the DHSS LAN
  Telecommunications and Perimeter    with the State of Alaska (SOA) wide
  Security                            area network, telecommunications
                                      and perimeter security managed by
                                      Department of Administration (DOA)
                                      Office of Information Technology
                                      (OIT)

  Accessibility                       Services to define IT accessibility
                                      standards. In practical terms, DHSS
                                      aims to meet the State of Alaska
                                      compliance program with the
                                      American's with Disabilities Act

  MITA/NHSIA                          Services to support community of
                                      practice style adoption of
                                      MITA/NHSIA standards
  -----------------------------------------------------------------------
...
Note that specific technology product standards are located in *IT
Reference D: DHSS Information Technology Standards*, which is structured
...
See *IT Reference D---DHSS Information Technology Standards* for details
...
platform. See *IT Reference D---DHSS Information Technology Standards*
...
> The Offeror will use the software identified in *IT Reference D---DHSS
...
that support technical services such as:
  ...
  -----------------------------------------------------------------------
  **Business Service**                **Example Technical Service
                                      Component**
  ----------------------------------- -----------------------------------
  ...
  Reporting and Business Intelligence Microsoft SQL Server Reporting
                                      Services
  ...
  Domain, Directory, Authentication,  Microsoft Active Directory
  Policy                              

  Host Intrusion Prevention, Policy,  McAfee
  Anti-virus                          
...
See *IT Reference D---DHSS Information Technology Standards* for the
...
> and disposal of sensitive information (IT Reference F---Data
> Destruction Information and References), if applicable.
...
Department's current IT security standards are provided in IT Reference
...
met. See *IT Reference D---DHSS Information Technology Standards \>
...
> DHSS currently deployed web browser version(s) -- See IT Reference D
...
> located in *IT Reference D---DHSS Information Technology Standards*.
...
> section *3.9.1.4 Requirement -- Hosting Platform Alignment*
> requirement below.
